...
class $fbafa14c3ac31938$export$3d6843c2c4a1bd6c extends (0, $bsgU1.Framework) {
    ...
    async get_image() {
        ...
        let volumeData = this.instance.volumes[0].getVolumeData([
            0,
            0,
            0
        ], [
        ...
        let pixels = (0, $gk9zP.Util).rgba_to_grayscale(volumeData);
        return {
            "data": pixels,
            "width": dims[2],
            "height": dims[1]
    ...
    async set_image(new_pixels) {
        if (this.instance.volumes.length > 0) {
            let dims = this.instance.volumes[0].dims.slice(1, 4);
            this.instance.volumes[0].setVolumeData([
                0,
                0,
                0
            ], [
        ...
        } else console.error("No volumes loaded in Niivue");
    }
    ...
    async set_mask(new_mask) {
        ...
        let dims = this.instance.volumes[0].dims.slice(1, 4);
        this.instance.volumes[1].setVolumeData([
            0,
            0,
            0
        ], [
