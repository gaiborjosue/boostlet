...
class Util {
    static detect_framework() {
        ...
        else if (Util.is_defined(window.AMI)) framework = new (0, $3Jzlj.Ami)(loader.data[0]);
        else if (Util.is_defined(window.vtk)) framework = new Vtk(loader.data[0]);
...
parcelRegister("3Jzlj", function(module, exports) {

$parcel$export(module.exports, "Ami", () => $2b80fd665282ceb1$export$f2db421b9db497a5);

var $bsgU1 = parcelRequire("bsgU1");
parcelRequire("gk9zP");
class $2b80fd665282ceb1$export$f2db421b9db497a5 extends (0, $bsgU1.Framework) {
    constructor(instance){
        super(instance);
        this.name = "ami";
    }
