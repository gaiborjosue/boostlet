   ...
   **/ set_image(new_pixels, is_rgba, no_flip) {
    ...
    select_box(callback) {
        ...
        canvas.addEventListener("mousedown", (function(e) {
            ...
            var rect = e.currentTarget.getBoundingClientRect(), offsetX = e.clientX * window.devicePixelRatio - rect.left * window.devicePixelRatio, offsetY = e.clientY * window.devicePixelRatio - rect.top * window.devicePixelRatio;
            this.x1 = offsetX;
            this.y1 = offsetY;
        }).bind(this));
